...
// ------------------------------------------------------------
// 2. БЮДЖЕТ ВИЛОЯТА – 253.4 млрд сум (кредиты O‘zmilliybank)
// ------------------------------------------------------------
const totalRegionBudget = 253.4; // млрд сум
...
const LoansDetailVil = () => {
    ...
    const handlePathClick = (districtName: string) => {
        if (districtName === "Qarshi shahri") {
            navigate("/loans-detail/kashkadarya/mahallalar");
        }
    };
            ...
            <Flex justify="space-between" mb={4} flexWrap="wrap" gap={2}>
                <Box>
                    <Heading size="lg" color="gray.800">
                        Qashqadaryo viloyati – O‘zmilliybank kreditlari
                    </Heading>
                ...
                <Box textAlign="right">
                    <Text fontSize="sm" color="gray.600">Jami kreditlar</Text>
