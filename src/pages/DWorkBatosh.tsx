        ...
        >
          <Flex justify="space-between" align="center">
            <HStack spacing={2}>
              ...
              <Heading size="md" color="white">{credit.borrowerName}</Heading>
            </HStack>
        ...
        <Box p={5}>
          <VStack align="start" spacing={4}>
            <Flex gap={3} w="100%">
              ...
              <Text color="gray.300" fontWeight="medium">{credit.purpose}</Text>
            </Flex>
            <SimpleGrid columns={2} spacing={4} w="100%">
              <Box>
                <Text fontSize="xs" color="gray.400">Summa</Text>
                <Text fontSize="xl" fontWeight="bold" color={brand600}>{credit.amount.toFixed(1)} mln so‘m</Text>
              </Box>
              <Box>
                <Text fontSize="xs" color="gray.400">Foiz stavkasi</Text>
                <Text fontSize="xl" fontWeight="bold" color="white">{credit.interestRate}%</Text>
              </Box>
              <Box>
                <Text fontSize="xs" color="gray.400">Muddati</Text>
                <Text fontSize="md" fontWeight="medium" color="white">{credit.termMonths} oy</Text>
              </Box>
              <Box>
                <Text fontSize="xs" color="gray.400">Qaytarilish</Text>
            ...
            <Flex justify="space-between" align="center" w="100%">
              <HStack spacing={2}>
                ...
                <Text fontSize="xs" color="gray.400">{credit.startDate} – {credit.endDate}</Text>
              </HStack>
              {credit.hasRedFlag && (
                <HStack spacing={1}>
            ...
            <IconButton
              ...
              _hover={{ bg: brand600, color: "white" }}
            />
          </VStack>
        </Box>
      </Box>
    ...
    <Box minH="100vh">
      <Box mx="auto">
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 5 }} spacing={4} mb={8}>
          <Stat bg="dark.card" p={4} borderRadius="xl">
            <Flex align="center" gap={2}>
              <DollarSign size={20} color={brand600} />
              <StatLabel color="gray.400">Jami kreditlar</StatLabel>
            </Flex>
          ...
          <Stat bg="dark.card" p={4} borderRadius="xl">
            <Flex align="center" gap={2}>
              ...
              <StatLabel color="gray.400">Faol kreditlar</StatLabel>
            </Flex>
          ...
          <Stat bg="dark.card" p={4} borderRadius="xl">
            <Flex align="center" gap={2}>
              ...
              <StatLabel color="gray.400">Kechiktirilgan / Muddati o‘tgan</StatLabel>
            </Flex>
          ...
          <Stat bg="dark.card" p={4} borderRadius="xl">
            <Flex align="center" gap={2}>
              ...
              <StatLabel color="gray.400">Red flag kreditlar</StatLabel>
            </Flex>
          ...
          <Stat bg="dark.card" p={4} borderRadius="xl">
            <Flex align="center" gap={2}>
              ...
              <StatLabel color="gray.400">O‘rtacha qaytarilish</StatLabel>
            </Flex>
            ...
            <Box bg="dark.card" p={4} borderRadius="xl">
              <ResponsiveContainer width="100%" height={300}>
                <BarChart layout="vertical" data={chartData} margin={{ top: 20, right: 30, left: 180, bottom: 20 }}>
                  ...
                  <XAxis type="number" tick={{ fill: "#cbd5e0" }} label={{ value: "mln so‘m", position: "insideBottom", offset: -5, fill: "#cbd5e0" }} />
                  <YAxis type="category" dataKey="name" tick={{ fontSize: 12, fill: "#cbd5e0" }} width={170} />
                  <Tooltip contentStyle={{ backgroundColor: "#1a202c", borderRadius: "8px", border: "none", color: "white" }} />
        ...
        {/* Ikkita karta */}
        <Heading size="lg" mb={4} color="white">Kreditlar ro‘yxati</Heading>
        ...
        {/* Xulosa */}
        <Box bg="dark.card" p={5} borderRadius="xl" mt={4}>
          <Flex gap={3} align="center" mb={3}>
            <AlertTriangle size={20} color={red400} />
            <Heading size="sm">Xulosa</Heading>
          </Flex>
