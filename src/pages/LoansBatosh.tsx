...
// --- Данные контрактов для Batosh (Kreditlar) ---
// Целевая сумма Batosh для кредитов: 553.25 млрд сум (из MainQarshi)
const targetBatoshBudget = 553.25; // млрд сум

// Базовые контракты (шаблоны, масштабируем до целевой суммы)
const contractsRaw = [
  {
    id: 5,
    name: "Mahalla ichki yo‘llarini asfaltlash",
    type: "Yo‘l qurilishi",
    amount: 2.45,
    date: "2025-02-05",
    status: "Bajarilmoqda",
  ...
  {
    id: 3,
    name: "Mahalla markaziy kanalini tozalash",
    type: "Suv xo‘jaligi",
    amount: 0.95,
    date: "2025-03-01",
    status: "Bajarildi",
  ...
  {
    id: 4,
    name: "Ko‘cha yoritish uchun transformator o‘rnatish",
    type: "Elektr ta'minoti",
    amount: 1.23,
    date: "2025-02-15",
    status: "Bajarilmoqda",
    checkPassed: false,
  ...
  {
    id: 53,
    name: "Bolalar maydonchasini qurish",
    type: "Obodonlashtirish",
    amount: 0.67,
    date: "2025-03-10",
    status: "Tugatilgan",
    checkPassed: true,
  ...
  {
    id: 64,
    name: "Feldscherlik punktini ta'mirlash",
    type: "Ijtimoiy infratuzilma",
    amount: 1.56,
    date: "2025-01-28",
    status: "Bajarildi",
    checkPassed: false,
  ...
  {
    id: 7,
    name: "Mahalla ichki suv quvurlarini almashtirish",
    type: "Suv ta'minoti",
    amount: 2.12,
    date: "2025-02-25",
...
// Масштабирование до целевой суммы
...
const LoansBatosh = () => {
  ...
  const handleRowClick = (contractId: number) => {
    ...
    if (contractId === 5 || contractId === 6) {
      navigate(`/kashkadarya/mahalla/batosh/contract/${contractId}`);
    }
  };

  const isClickable = (id: number) => id === 5 || id === 6;
        ...
        <Flex alignItems="baseline" justifyContent="space-between" mb={6}>
          <Box>
            <Heading as="h1" size="xl" fontWeight="bold" color="gray.800">
              Batosh mahallasi – Kreditlar
            </Heading>
            <Text fontSize="md" color="brand.300" mt={1}>
              Jami tijorat bank kreditlari (140 trln so‘m) – Qarshi shahri, Batosh mahallasi
            </Text>
          </Box>
        </Flex>
