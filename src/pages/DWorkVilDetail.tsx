    ...
    return (
        <Box minH="100vh">
            <Flex direction="column" gap={4}>
                ...
                <Box mt={6}>
                    <Heading as="h2" size="lg" mb={4}>ishsizlik darajasi (yil boshi, hozirgi, maqsad)</Heading>
                    ...
                    <Box bg="dark.card" p={4} borderRadius="xl">
                        <ResponsiveContainer width="100%" height={Math.max(500, chartData.length * 32)}>
                            <BarChart layout="vertical" data={chartData} margin={{ top: 20, right: 30, left: 120, bottom: 20 }}>
                                ...
                                <XAxis type="number" domain={[0, 5]} tick={{ fill: "#cbd5e0" }} label={{ value: "ishsizlik %", position: "insideBottom", offset: -5, fill: "#cbd5e0" }} />
