// src/pages/QarshiMahallaPoverty.tsx
...
// ------------------------------
// MAHALLA DARAJASIDAGI KAMBAG‘ALLIK MA’LUMOTLARI
...
function generateMahallaData(): MahallaPoverty[] {
  ...
  // Shahar o‘rtacha yil boshi: 3.8%, maqsad: 3.3%
...
const QarshiMahallaPoverty = () => {
  ...
  const handleDetailClick = (mahallaName: string) => {
    if (mahallaName === "Batosh") {
      navigate("/poor-level/vil/qarshi/batosh");
    }
  };
...
export default QarshiMahallaPoverty;